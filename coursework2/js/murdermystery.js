...
transitionAnswered=()=>{
  ...
  let speaker = document.getElementById("speaker").style.display = "none"; /* There is no narration on the next page, therefore the speaker is set to none so that the icon does not display.*/
  let audio = document.getElementById("narration");
...
transitionMustAnswer=()=>{
  ...
  let speaker = document.getElementById("speaker").style.display = "none";
  let audio = document.getElementById("narration");
  audio.pause();
  setTimeout (pageDelayAnswered, 1000);
};
...
transition3=()=>{
  ...
  let speaker = document.getElementById("speaker").style.display = "block"; /* The speaker is set back to block here as it is required for all but one of the remaining pages*/
...
questioningClarissa3=()=>{//This function works with the transition5B()
  let dialogueC1 = document.getElementById("dialogueC1").textContent = ("“Yes he did. He had such good taste. My favourite is my emerald pendant bracelet, it's beautiful.”");
  let dialogueC2 = document.getElementById("dialogueC2").textContent = ("What would you like to do next?");
  createClarissaButtons();
};
